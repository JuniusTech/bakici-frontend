      ...
      <div className='login-form'>
        ...
        <button className='login-form-btn'>
          ...
          <span className='login-form-text-span'>•••••</span>
            ...
            <br />
            <input type="text" placeholder='mail@gmail.com' className='login-form-input-email' /><br />
            <label htmlFor="password" className='login-form-label-password'>Şifre</label>
            <br />
            <input type="password" placeholder='Min. 6 karakter' className='login-form-input-password' /><br />
